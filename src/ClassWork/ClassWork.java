...
public class ClassWork {
    ...
    static class TicTacToe {
        ...
        int rowsBoardGrid = boardGrid.length - 1;
        int colsBoardGrid = boardGrid[0].length - 1;
        ...
        public boolean checkWinner(String player) {
            ...
            if (boardGrid[0][0] == "X" && boardGrid[0][1] == "X" && boardGrid[0][2] == "X" ||
                    boardGrid[0][0] == "O" && boardGrid[0][1] == "O" && boardGrid[0][2] == "O") {
                System.out.println(" WINNER " + player);
                return true;
            }

            if (boardGrid[1][0] == "X" && boardGrid[1][1] == "X" && boardGrid[1][2] == "X" ||
                    boardGrid[1][0] == "O" && boardGrid[1][1] == "O" && boardGrid[1][2] == "O") {
                System.out.println(" WINNER " + player);
                return true;
            }

            if (boardGrid[2][0] == "X" && boardGrid[2][1] == "X" && boardGrid[2][2] == "X" ||
            ...
            if (boardGrid[0][0] == "X" && boardGrid[1][0] == "X" && boardGrid[2][0] == "X" ||
                    boardGrid[0][0] == "O" && boardGrid[1][0] == "O" && boardGrid[2][0] == "O") {
                System.out.println(" WINNER " + player);
                return true;
            }

            if (boardGrid[0][1] == "X" && boardGrid[1][1] == "X" && boardGrid[2][1] == "X" ||
                    boardGrid[0][1] == "O" && boardGrid[1][1] == "O" && boardGrid[2][1] == "O") {
                System.out.println(" WINNER " + player);
                return true;
            }

            if (boardGrid[0][2] == "X" && boardGrid[1][2] == "X" && boardGrid[2][2] == "X" ||
            ...
            if (boardGrid[0][0] == "X" && boardGrid[1][1] == "X" && boardGrid[2][2] == "X" ||
                    boardGrid[0][0] == "O" && boardGrid[1][1] == "O" && boardGrid[2][2] == "O") {
                System.out.println(" WINNER " + player);
                return true;
            }

            if (boardGrid[0][2] == "X" && boardGrid[1][1] == "X" && boardGrid[2][0] == "X" ||
